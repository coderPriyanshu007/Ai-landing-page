  ...
  return (
    <div className="flex min-h-screen  items-center justify-center bg-black font-sans ">
      <img
        ...
        alt="hero background"
        className="w-full absolute top-0 z-20  min-h-screen"
      />
      <main className="flex overflow-hidden min-h-screen w-full z-20  flex-col items-center justify-between   sm:items-start">
        {/* Hero section */}
        ...
        <section className="w-full mt-24">
          <div className="max-w-7xl px-2 md:px-4 lg:px-8 mx-auto">
            <div className="max-w-4xl mx-auto flex flex-col lg:flex-row lg:gap-4  ">
              ...
              <p className="text-white font-semibold lg:text-2xl">
                Whether you're designing for personal projects, creative teams,
                or large-scale campaigns, our AI-powered platform is built to
                bring your ideas to life—quickly, beautifully, and
                intelligently.And the results? The numbers speak for themselves:
              </p>
            </div>

            <div className=" w-full flex flex-col lg:flex-row lg:min-h-[250px] gap-8  my-12 lg:my-24">
              <MileStones
                images={[
                  "/images/avatar/1.png",
                  "/images/avatar/2.png",
        ...
        <section className="w-full relative mt-20">
          <div className="md:w-[90%] w-full -top-100 absolute h-full -z-10 opacity-60 ">
          ...
          <div className="max-w-7xl  mx-auto px-2 md:px-4 lg:px-8 space-y-4">
            <div className="text-center space-y-2 lg:space-y-4 ">
              ...
              <p className="text-white/50">
                ...
                tools. Upgrade to the Pro Plan to unlock powerful AI
        ...
        {/* FAQ */}
        <section className="w-full relative   bg-black/50 lg lg:bg-transparent overflow-hidden  pt-20">
          {/* rounded rectangle */}
          <div className="w-30 md:w-40 h-60 md:h-80 absolute -z-10 top-0 -translate-x-2/3 lg:-translate-x-1/2 border-[#FF9777] border-16 rounded-full"></div>
          {/* white rounded rectangle */}
          <div className="w-60 h-30 md:w-80 md:h-40 absolute -z-10 bottom-0 -translate-x-2/3 lg:-translate-x-1/2 border-white border-16 rounded-full"></div>
          {/* orange circle */}
          <div className="size-60 md:size-100 border-16 rounded-full border-orange-600 -z-10 absolute top-1/6 right-0 translate-x-5/6 lg:translate-x-1/2"></div>

          <div className="max-w-5xl  relative mx-auto px-2 md:px-4  lg:px-8">
            {/* header */}
            <div className="text-center max-w-3xl mx-auto space-y-4 lg:space-y-6">
              <h1 className="text-3xl   text-white font-bold md:text-4xl lg:text-5xl">
                Frequently Asked Questions
              </h1>
              <p className="text-sm md:text-base mx-auto text-[#D9D9D9]">
        ...
        <div className="w-full relative mt-10">
          ...
          <div className="max-w-7xl  mx-auto px-2 md:px-6 lg:px-8 text-center">
            <div className="border relative backdrop-blur-[2px] max-w-6xl rounded-3xl mx-auto border-white/20 space-y-4 lg:space-y-6 py-20 ">
              {/* overlay */}
              <div
                style={{
              ...
              <div
                ...
                style={{
                  background:
                    "radial-gradient(50% 100% at 50% -25% , rgba(255, 255, 255, 0.4) 7.35%, rgba(255, 84, 31, 0.32) 24.23%, rgba(247, 175, 153, 0.4) 36%, rgba(255, 84, 31, 0.4) 49.99%, rgba(0, 0, 0, 0) 100%)",
                }}
              ></div>
